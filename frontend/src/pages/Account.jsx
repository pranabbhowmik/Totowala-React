            ...
            <div className="w-full max-w-md mx-auto bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
                ...
                <div className="p-4 md:p-6">
                    ...
                    <div className="mt-6 md:mt-8">
                        <h4 className="text-sm font-medium text-gray-500 mb-4 font-mono">Preferences</h4>
                        ...
                        <div className="flex items-center justify-between p-3 rounded-lg hover:bg-yellow-50 transition-all duration-300">
                            <div className="flex items-center">
                                ...
                                <span className="ml-3 font-medium text-gray-700 font-mono">Push Notifications</span>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-3 mt-2 rounded-lg hover:bg-yellow-50 transition-all duration-300 cursor-pointer group">
                            <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-6 md:w-6 text-gray-500 group-hover:text-yellow-500 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span className="ml-3 font-medium text-gray-700 group-hover:text-gray-900 font-mono">Help</span>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 group-hover:text-yellow-500 transition-colors duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="m9 18 6-6-6-6"/>
                            </svg>
                    ...
                    <div className="mt-6 md:mt-8 pb-4">
                        <button className="w-full flex items-center justify-center px-4 py-3 rounded-lg text-red-500 hover:bg-red-50 transition-all duration-300 group">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-6 md:w-6 group-hover:text-red-600 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                            </svg>
                            <span className="ml-2 font-bold text-lg group-hover:text-red-600 font-mono">Logout</span>
                        </button>
                    </div>
                </div>
            </div>
